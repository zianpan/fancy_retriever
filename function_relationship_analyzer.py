...
class FunctionRelationshipAnalyzer:
    ...
    def __init__(self, contexts: List[Dict[str, Any]]):
        ...
        try:
            ...
            print(f"Error initializing FunctionRelationshipAnalyzer: {e}")
            self.call_graph = {}
    ...
    def _build_call_graph(self) -> Dict[str, Set[str]]:
        ...
        for ctx in self.contexts:
            try:
                ...
                print(f"Error processing context in _build_call_graph: {e}")
                continue
    ...
    def _collect_function_signatures(self) -> Dict[str, Dict[str, Any]]:
        ...
        for ctx in self.contexts:
            try:
                ...
                print(f"Error processing context in _collect_function_signatures: {e}")
                continue
    ...
    def _determine_function_roles(self) -> Dict[str, str]:
        ...
        try:
            ...
            print(f"Error in _determine_function_roles: {e}")
        ...
        try:
            for ctx in contexts:
                try:
                    ...
                    print(f"Error processing context in boost_main_functions: {e}")
                    continue
        except Exception as e:
            print(f"Error in boost_main_functions: {e}")
